...
var pages = []Page{
	...
	{Slug: "proxies", Path: "/proxies", Title: "Proxies"},
	{Slug: "providers", Path: "/providers", Title: "Provider & VAU"},
	{Slug: "insurants", Path: "/insurants", Title: "Versicherte (KVNR)"},
	{Slug: "consent", Path: "/consent", Title: "Consent-Entscheidungen"},
	{Slug: "medication", Path: "/medication", Title: "Medikation"},
	{Slug: "errors", Path: "/errors", Title: "Fehler"},
}
