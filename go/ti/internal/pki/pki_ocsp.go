...
func newPKIOCSPCmdGroup(def common.EnvDef) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "ocsp",
...
func newPKIOCSPCheckCmd(def common.EnvDef) *cobra.Command {
...
func runOCSPCheck(ctx context.Context, def common.EnvDef, cert *x509.Certificate, f outputFormat, issuerPath, responder string, maxAge time.Duration) error {
...
func resolveIssuer(ctx context.Context, def common.EnvDef, cert *x509.Certificate, issuerPath string) (*x509.Certificate, error) {
	if issuerPath != "" {
